...
public class EmailController {
     ...
     public Mono<Boolean> sendHtmlEmail(@RequestBody EmailRequest emailRequest) {
         return emailService.sendHtmlEmail(emailRequest.getTo(), emailRequest.getSubject(), emailRequest.getContent());
     }
}
